...
export abstract class ContractsEnverEksCluster extends ContractsEnverCdk implements WithVpc {
    ...
    constructor(owner: ContractsBuild<ContractsEnverCdk>, targetAWSAccountID: string, targetAWSRegion: string, targetRevision: SRC_Rev_REF) {
        ...
        this.ipamPoolName = new ContractsCrossRefConsumer(this, 'ipamPoolName', owner.contracts.networking!.ipam_west1_le.ipamPoolName)
        this.transitGatewayShareName = new ContractsCrossRefConsumer(this, 'transitGatewayShareName', owner.contracts.networking!.ipam_west1_le.transitGatewayShareName)
        this.natPublicIP = new ContractsCrossRefConsumer(this, 'natPublicIP', owner.contracts.networking!.ipam_west1_le.natPublicIP)
    }
}
